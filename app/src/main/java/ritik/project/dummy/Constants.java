...
public static String TAG="Ritik";
    public static String NAME="GBU Directory";
    public static String SERVER_IP="192.168.2.100";
    public static String URL_REGISTER="http://"+SERVER_IP+"/dummy/register.php";
